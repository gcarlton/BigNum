...
// March down list until we find the previous element
    ...
    //This method iterates through the list to chick if the item exists.
    public boolean contains(Object item){
        Link x = head.next();
        while(x != tail){
            if(x.element().equals(item)){
                return true;
            }
            x = x.next();
        }
    ...
    //This method retrieves the element at the specified index or returns null if the index is out of bounds.
